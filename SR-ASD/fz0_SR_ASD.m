...
clc
clear
load fz0.mat %st is fault data.
load fz0_before_adding_the_noise.mat %%st1 is fault data.
...
y=st;
lam1=0.6228;
lam2=0.2316; % lam1 and lam2 are set based on the noise standard deviation
